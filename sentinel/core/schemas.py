"""Core schemas, enums, and data models for SENTINEL."""
...
class Authorization(SentinelBase):
    engagement_id: str
...
class ToolCapability(SentinelBase):
    name: str
    version: str = ""
    description: str = ""
