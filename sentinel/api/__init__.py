...
from sentinel.web import normalize_target_url
...
dashboard_app = FastAPI(title="SENTINEL Dashboard", version="1.0.0")
...
try:
    from sentinel.api.routes import router as api_router
...
async def index():
    ...
    from sentinel.api.frontend import get_dashboard_html
