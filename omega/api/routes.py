"""REST API routes wrapping the real OMEGA engines."""
...
from omega.tools import ToolRegistry, ToolExecutor, ToolExecutionRequest, load_adapters
...
logger = logging.getLogger("omega.api.routes")

router = APIRouter(prefix="/api", tags=["dashboard"])


def _broadcast(event_type: str, data: dict) -> None:
    """Lazy import to avoid circular dependency with omega.api."""
    try:
        from omega.api import broadcast_event as _be
        _be(event_type, data)
    except Exception:
        pass
